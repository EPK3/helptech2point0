  ...
  return (
    <div>
        ...
        <div className='flex flex-wrap'>
          ...
          <div className='flex-col flex-1 bg-slate p-10 min-w-[350px]'>
          ...
          <div className='flex-1 min-w-[350px]'>
            <img src={laptopDesk} alt='Something went wrong...'/>
          </div>
          <div className='flex-col flex-1 bg-slate p-10 min-w-[350px]'>
        ...
        <div className='flex flex-col m-auto justify-center my-28'>
          <h1 className='text-center text-black text-xl xl:text-4xl'>When your phone, tablet, or laptop breaks you want an expert to handle the repair.</h1>
        ...
        <div style={{ backgroundImage: `url('${bottomBanner}')` }}className="flex bg-cover bg-center w-full h-auto z-0">
          <div className='flex flex-col border-2 border-white m-auto my-28 w-[300px] xl:w-[50%] justify-center text-center'>
            <h1 className='text-orange text-2xl xl:text-6xl mt-5 xl:mt-12'>Getting help is easy!</h1>
